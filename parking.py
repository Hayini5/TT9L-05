...
# Load the image
bg_image = tk.PhotoImage(file=r"C:\TT9L-05\TT9L-05-2\images\road-highway.png")
...
def button_sign_up():
    ...
    signup_bg_image = tk.PhotoImage(file=r"C:\TT9L-05\TT9L-05-2\images\othera pic.png")
...
def student_login():
    ...
    student_bg_image = tk.PhotoImage(file=r"C:\TT9L-05\TT9L-05-2\images\othera pic.png")
...
def parking_system():
    ...
    parking_system_bg_image = tk.PhotoImage(file=r"C:\TT9L-05\TT9L-05-2\images\road-highway.png")
...
def open_booking_window():
    ...
    book_bg_image = tk.PhotoImage(file=r"C:\TT9L-05\TT9L-05-2\images\road-highway.png")
        ...
        if reservation_data and reservation_data[1] == logged_in_student_email:
            ...
            def extend():
                ...
                def update_end_time(minutes):
                    ...
                    # Change button color to yellow after successful extension
                    button_dict[space].config(bg='yellow')
...
def foe_layout():
    ...
    def reserve_space(space, button_dict):
        ...
        def confirm_reservation():
            ...
            if chosen_start_time == "0:00:00" or chosen_end_time == "0:00:00":
                messagebox.showerror("Error", "Start time and end time cannot be 0:00.")
                return
        ...
        confirm_button = tk.Button(time_selection_window, text="Reserve", bg='green', font=("Microsoft YaHei UI Light", 10), fg='white', command=confirm_reservation)
        confirm_button.grid(row=3, columnspan=3, pady=20)
...
def guard_login():
    ...
    guard_bg_image = tk.PhotoImage(file=r"C:\TT9L-05\TT9L-05-2\images\othera pic.png")
...
def parking_checking():
    ...
    parking_checking_bg_image = tk.PhotoImage(file=r"C:\TT9L-05\TT9L-05-2\images\road-highway.png")
